...
<div class="container index-page">
    <h2 class="consigliati-title">Manga</h2>
    ...
    %>
        <div class="comic">
            <img src="<%= request.getContextPath() %>/images/<%= c.getImage() %>"
                 alt="<%= c.getTitle() %>" />
            <h3><%= c.getTitle() %></h3>
    ...
    %>
        <p>Errore nel caricamento dei manga.</p>
    <%
        }
    %>
    </div>
...
<script src="<%= request.getContextPath() %>/scripts/manga.js"></script>
